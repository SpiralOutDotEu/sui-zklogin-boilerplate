    ...
    <div className='min-h-[80vh] flex items-center justify-center'>
      <div className='max-w-4xl mx-auto text-center space-y-8'>
        ...
        <div className='space-y-6'>
          <h1 className='text-6xl font-bold gradient-text leading-tight'>Welcome to Sui zkLogin</h1>
          <p className='text-xl text-white/70 max-w-2xl mx-auto leading-relaxed'>
            Experience the future of Web3 authentication with zero-knowledge proofs. Connect your
            Google account seamlessly without compromising your privacy.
          </p>
        </div>
        ...
        <div className='grid md:grid-cols-3 gap-6 mt-16'>
          ...
          <div className='glass-effect rounded-2xl p-6 hover:scale-105 transition-transform duration-300'>
            ...
            <p className='text-white/60 text-sm'>Connect in seconds with familiar OAuth flow</p>
          </div>
          ...
          <div className='glass-effect rounded-2xl p-6 hover:scale-105 transition-transform duration-300'>
            ...
            <p className='text-white/60 text-sm'>Built on Sui's battle-tested cryptography</p>
          </div>
        </div>
          ...
          <div className='glass-effect rounded-2xl p-8 max-w-2xl mx-auto mt-12'>
            ...
            <div className='space-y-3'>
              <div className='bg-white/5 rounded-lg p-4'>
                ...
                <div className='font-mono text-white break-all'>{account.address}</div>
              </div>
              {decodedJwt?.email && (
                <div className='bg-white/5 rounded-lg p-4'>
                  <div className='text-sm text-white/60 mb-1'>Connected Email</div>
